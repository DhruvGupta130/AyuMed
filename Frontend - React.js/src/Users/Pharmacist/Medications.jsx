...
import {Alert, Button, Card, Form, Input, message, Modal, Spin, Table} from 'antd';
            ...
            <Card title={<Title level={3}>Medications List</Title>} className="Medications-list-card">
                ...
                {!loading && !error && (
                    <div className='button-box'>
                        <Button type="primary" icon={<MedicationSharp/>} onClick={handleRegisterModalOpen}
                                className="register-button" style={{width: '100%'}}>
                            Add New Medication
                        </Button>
                        <Button type="primary" icon={<UploadOutlined/>} onClick={handleBulkUploadModalOpen}
                                className="register-button" style={{width: '100%'}}>
